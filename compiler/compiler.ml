...
let primitive_names_to_labels = 
  ["boolean?", "is_boolean"; "float?", "is_float"; "integer?", "is_integer"; "pair?", "is_pair";
   ...
   "car", "pair_car" ; "cdr", "pair_cdr" ; "cons", "cons_to_pair" ; "set-car!",  "set_car_of_pair" ; "set-cdr!" , "set_cdr_of_pair"; "apply", "apply_tomer" 
...
main:
    ...
    ;; Set up the primitive string_to_astsstdlib fvars:
...
try
  ...
  let prims_tbl = Code_Gen.create_primitives primitive_names_to_labels in
  let fvars_tbl = Code_Gen.make_fvars_tbl asts prims_tbl in
